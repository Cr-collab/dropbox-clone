class DropBoxController {
    ...
    connectFirebase()
    {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDBPyJMZ1u-VB8x2jcqOIIjhz95OI3YEFE",
            authDomain: "dropbox-clone-9ba99.firebaseapp.com",
            databaseURL: "https://dropbox-clone-9ba99-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-9ba99",
            storageBucket: "dropbox-clone-9ba99.appspot.com",
            messagingSenderId: "246009516490",
            appId: "1:246009516490:web:073b6a8f6a23a604f3bf33",
            measurementId: "G-4FYKDYXE23"
        };
        // Initialize Firebase
    ...
    uploadProgress(event, file) {
        ...
        //calculando a porcenragem para atualizar width da barrinha de progresso
        ...
        //atualizando a barra de prgresso

        this.namefileEl.innerHTML = file.name;
        // estamos setando o valor do arquivo escolhido pelo usuario
    ...
    linha/** a linha  */.addEventListener/*Escutando*/('click' /** o evento click */, e =>
       {
        ...
        if(e.shiftKey/** tem ai evento junto com tecla shift */)
        {
                    ...
                    {
                          let indexStar;
                          // pegar o primeiro li escolhida
                          let indexEnd;
                          // pegar o ulimo li escolhida

                      

                        linha.parentElement.childNodes.forEach((el,index) =>
                          {
                              if(firstLi === el) indexStar = index;
                              if(linha === el) indexEnd = index;
                          });

                          let index1 = [indexStar,indexEnd].sort();
                          
                          linha.parentElement.childNodes.forEach((el,i) =>
                          {
                               if( i >=  index1[0] && i <= index1[1])
                               {
         ...
         if(!e.ctrlKey/** se não tiver evento junto com tecla ctrl */)
         {
             this.listFileEl/** ul onde esta a li */.querySelectorAll/** pesquisando o que esta dentro da ul */('li.selected'/** tem ai dentro 
             li com classe selected */).forEach(el =>
                {
                    /** para cad elemento que tiver a li com a classe selected vou fazer o que ? */
                    el/** pego o elemento */.classList/** entro na suas classes */.remove('selected')/** e removo a classe dentro parenteses */;
